        ...
        <ul class="header-menu nav navbar-nav">
            ...
            <li class="dropdown" id="language-header">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="#" data-lang="en"><img src="{!! url('public') !!}/assets/images/flags/usa.png" alt="flag-english"> <span>English</span></a>
                    </li>
                    <li>
                        <a href="#" data-lang="es"><img src="{!! url('public') !!}/assets/images/flags/spanish.png" alt="flag-english"> <span>Español</span></a>
                    </li>
                    <li>
                        <a href="#" data-lang="fr"><img src="{!! url('public') !!}/assets/images/flags/french.png" alt="flag-english"> <span>Français</span></a>
                    </li>
                </ul>
            </li>
            <!-- END USER DROPDOWN -->
            ...
            <li class="dropdown" id="messages-header">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-body">
                        ...
                        <img src="{!! url('public') !!}/assets/images/avatars/avatar3.png" alt="avatar 3">
                        </span>
                                <div class="clearfix">
                                    <div>
                            ...
                            <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="{!! url('public') !!}/assets/images/avatars/avatar4.png" alt="avatar 4">
                        </span>
                                <div class="clearfix">
                                    <div>
                            ...
                            <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="{!! url('public') !!}/assets/images/avatars/avatar5.png" alt="avatar 5">
                        </span>
                                <div class="clearfix">
                                    <div>
                            ...
                            <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="{!! url('public') !!}/assets/images/avatars/avatar6.png" alt="avatar 6">
                        </span>
                                <div class="clearfix">
                                    <div>
            ...
            <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <img src="{!! url('public') !!}/assets/images/avatars/user1.png" alt="user image">
