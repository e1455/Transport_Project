...
@section('content')
    <div class="header">
        ...
        <div class="breadcrumb-wrapper">
            ...
            <ol class="breadcrumb" >
                ...
                <li class="active" style="text-transform: capitalize;font-size:1em;">Edit {!! $employee->user->name !!}&nbsp;{!! $employee->user->family !!}&nbsp;Information</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <form role="form" class="form-horizontal form-validation" method="post" action="{!! route('UpdateEmployee') !!}">
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-header bg-primary-dark">
                        <h2 class="panel-title" style="text-transform: capitalize"><i class="glyphicon glyphicon-user"></i>Edit Personal Information</h2>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group @if($errors->has('user.name')) has-error @endif">
                                    ...
                                    <div class="col-sm-9 ">
                                        <input type="text" name="user[name]"  id="name" class="form-control"  value="{!! $employee->user->name !!}" required />
                                ...
                                <div class="form-group @if($errors->has('user.family')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="user[family]" id="family" class="form-control" value="{!! $employee->user->family !!}" required />
                                ...
                                <div class="form-group @if($errors->has('user.email')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" name="user[email]" id="email" class="form-control" value="{!! $employee->user->email !!}" required />
                                ...
                                <div class="form-group @if($errors->has('user.national_code')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="user[national_code]" id="national_code" class="form-control" value="{!! $employee->user->national_code !!}" required />
                                ...
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <div class="pull-right">
                                            <button type="submit" class="btn btn-embossed btn-success m-r-20">Save Changes</button>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="employee[vehicle_id]" id="vehicle_id" class="form-control">
                                            ...
                                            @foreach($vehicles as  $vehicle)
                                                <option value="{!! $vehicle->id !!}" @if($employee->vehicle_id == $vehicle->id) selected @endif>{!! $vehicle->name !!}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group @if($errors->has('employee.plate_number')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="employee[plate_number]" id="plate_number" class="form-control" value="{!! $employee->plate_number !!}" required />
                                ...
                                <div class="form-group @if($errors->has('employee.start_service')) has-error @endif">
                                    ...
                                    <div class="col-sm-9 ">
                                        <input type="text" data-mask="99:99:99" name="employee[start_service]" id="start_service" class="form-control" value="{!! $employee->start_service !!}" required />
                                ...
                                <div class="form-group @if($errors->has('employee.end_service')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" data-mask="99:99:99" name="employee[end_service]" id="end_service" class="form-control" value="{!! $employee->end_service !!}"  required />
                                ...
                                <div class="form-group @if($errors->has('employee.wage_over_distance')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="employee[wage_over_distance]" id="wage_over_distance" value="{!! $employee->wage_over_distance !!}"  class="form-control"/>
                                ...
                                {{-- Score --}}
                                <div class="form-group @if($errors->has('employee.score')) has-error @endif">
                                    <label class="col-sm-3 control-label" for="score">Score</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="employee[score]" id="score" value="{!! $employee->score !!}"  class="form-control"/>
                                        @if($errors->has('employee.score')) <span style="color: red"> {!! $errors->first('employee.score') !!} </span>@endif
