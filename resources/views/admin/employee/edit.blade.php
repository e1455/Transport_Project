                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 ">
                                        <input type="time" name="employee[start_service]" id="start_service" class="form-control" value="{!! $employee->start_service !!}" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="time" name="employee[end_service]" id="end_service" class="form-control" value="{!! $employee->end_service !!}"  required />
                                    </div>
                                </div>
